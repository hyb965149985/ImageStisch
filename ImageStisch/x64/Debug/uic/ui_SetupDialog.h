...
"QPushButton::disabled{background: #cccccc; color:#eeeeee;}"));
    ...
    void retranslateUi(QDialog *SetupDialog)
    {
        ...
        cboxFuse->insertItems(0, QStringList()
         ...
         << QApplication::translate("SetupDialog", "\346\234\200\345\244\247\345\200\274\350\236\215\345\220\210\347\256\227\346\263\225", Q_NULLPTR)
        );
        cboxFeature->clear();
        cboxFeature->insertItems(0, QStringList()
         << QApplication::translate("SetupDialog", "Sift\347\256\227\345\255\220", Q_NULLPTR)
