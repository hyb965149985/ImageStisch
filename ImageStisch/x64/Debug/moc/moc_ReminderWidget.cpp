...
void ReminderWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ReminderWidget *_t = static_cast<ReminderWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ReminderWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ReminderWidget.data,
      qt_meta_data_ReminderWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ReminderWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ReminderWidget.stringdata0))
        return static_cast<void*>(const_cast< ReminderWidget*>(this));
